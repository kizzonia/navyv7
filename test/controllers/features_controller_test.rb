...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post features_url, params: { feature: { body: @feature.body, fimg: @feature.fimg, slug: @feature.slug, sub_title: @feature.sub_title, title: @feature.title } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { body: @feature.body, fimg: @feature.fimg, slug: @feature.slug, sub_title: @feature.sub_title, title: @feature.title } }
