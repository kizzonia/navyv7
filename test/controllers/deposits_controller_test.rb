...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post deposits_url, params: { deposit: { account_name: @deposit.account_name, account_number: @deposit.account_number, amount: @deposit.amount, btcnote: @deposit.btcnote, btcw: @deposit.btcw, date: @deposit.date, ethw: @deposit.ethw, method: @deposit.method, routing_number: @deposit.routing_number, status: @deposit.status, swiftcode: @deposit.swiftcode, user_id: @deposit.user_id } }
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { account_name: @deposit.account_name, account_number: @deposit.account_number, amount: @deposit.amount, btcnote: @deposit.btcnote, btcw: @deposit.btcw, date: @deposit.date, ethw: @deposit.ethw, method: @deposit.method, routing_number: @deposit.routing_number, status: @deposit.status, swiftcode: @deposit.swiftcode, user_id: @deposit.user_id } }
