...
class TransactionsTest < ApplicationSystemTestCase
  ...
  test "creating a Transaction" do
    ...
    fill_in "Purpose", with: @transaction.purpose
    fill_in "Sender", with: @transaction.sender
    fill_in "Slug", with: @transaction.slug
    check "Status" if @transaction.status
    fill_in "Transac type", with: @transaction.transac_type
